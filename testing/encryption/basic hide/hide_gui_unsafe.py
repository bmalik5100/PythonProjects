...
def main(mode_switch):
    ...
    #    time.sleep(3)
    #    sys.exit()
    #elif len(sys.argv) != 4: # old command based version. Forgot why its still here...
...
def get_single_file():
    ...
    ALTER_LOCATION = filedialog.askopenfilename(filetypes=(("All Files", "*.*"),
                                                           ...
                                                           ("JPEG Files", "*.jpeg"),
                                                           ("Text files", "*.txt")))
    file_confirmation = Label(text=ALTER_LOCATION+" selected.", fg="green")
    file_confirmation.place(x=230, y=85)
